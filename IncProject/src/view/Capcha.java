...
public class Capcha extends BaseDialog {
	...
	private void data() throws IOException, SAXException, ParserConfigurationException {
		...
		count = com.getItemCount();
		com.setSelectedIndex(random.nextInt(count)); // combobox의 아이템 무작위로 선택
		com.addActionListener(new ActionListener() { // combobox의 목록에서 아이템 선택시 shuffle
